...
const HeroPage: React.FC = () => {
  ...
  return (
    <section className="bg-[#0B1120] text-[#F1F5F9] min-h-screen flex flex-col lg:flex-row  justify-center lg:justify-around   items-end  overflow-hidden relative   lg:gap-10 max-w-7xl mx-auto  lg:pt-16 px-5 lg:px-10">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-4 text-sm justify-center md:justify-start w-full ">
          <Link href="/course-materials" className="bg-[#D4AF37] text-[#0B1120] px-8 py-2.5 rounded-full font-semibold transition-all hover:bg-[#F1F5F9] active:scale-95 w-full text-center ">
            Find Past Questions
          </Link>
